...
class GaussianDiffusion:
    ...
    def __init__(
        ...
        *,
        ...
        # coefficients for noise schedule
        # betas2 = gen_coefficients(
        #     timesteps, schedule="increased", sum_scale=0.01)
    ...
    def q_noisy_sample(self, x_start, t, noise=None):
        """
        Diffuse the data for a given number of diffusion steps.
        ...
        return (
            x_start
            + _extract_into_tensor(self.betas_cumsum, t, x_start.shape)* noise
        )
    ...
    def training_losses(self, model, imgs, t, model_kwargs=None, noise=None):
        """
        ...
        if noise is None:
            noise = th.randn_like(x_start)
        x_t = self.q_noisy_sample(x_start, t, noise=noise)
